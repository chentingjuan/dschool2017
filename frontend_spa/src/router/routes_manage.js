...
let routes = {
  ...
  children: [
    ...
    { 
      path: 'member', component: ManageMemberEdit, props: true ,
      meta: {
        title: "會員管理",
        mainNav: true
      }
    ...
    { 
      path: 'member/:id', component: ManageMemberEdit, props: true ,
      meta: {
        title: "會員資料"
      }
    },
    { 
      path: 'question', component: ManageQuestionEdit, props: true ,
      meta: {
        title: "問答管理",
        mainNav: true
      }
    ...
    { 
      path: 'question/:id', component: ManageQuestionEdit, props: true ,
      meta: {
        title: "問答"
      }
    },
    { 
      path: 'user', component: ManageUser, props: true ,
      meta: {
        title: "使用者",
        mainNav: true
      }
    ...
    { 
      path: 'equipment/list', component: ManageEquipList ,
      meta: {
        title: "設備管理",
        mainNav: true
      }
